...
(function (root) {
  ...
  var CONFIG = {
    ...
    /* ---- مفتاح فكّ التشفير ----
     * بناءً على قرار صريح بإلغاء كلمة مرور الكتالوج المشتركة، صار المفتاح
     * مضمّنًا هنا ويفكّ التطبيق التشفير تلقائيًا دون سؤال المستخدم.
     *
     * ⚠️ هذا يعني أن الملف المشفّر لم يعد سرًّا فعليًا: أي شخص يفتح الموقع أو
     * المستودع يستطيع استخراج هذا المفتاح وقراءة كل بيانات الكتالوج،
     * *وكذلك رمز الكتابة في GitHub المخزَّن داخل الملف نفسه* — أي الكتابة في
     * المستودع لا القراءة فقط. الحماية الحقيقية الوحيدة الباقية هي أن الرابط
     * غير معلن. الأدوار والحسابات تنظيمية في الواجهة ولا تحمي البيانات.
     * لإعادة الحماية: أعِد تفعيل كلمة مرور يدخلها المستخدم، أو انقل المفتاح
     * ليكون لكل حساب نسخته المغلّفة بكلمة مروره الشخصية. */
    catalogKey: "mUoU+a9QawwjVK5x3D2zsUINZqaypiHtHHPJM8hIWMc=",
